...
void initScene(GLFWwindow* window)
{
    ...
    programLight.attachShader("./shaders/vertexColorLight.glsl",GL_VERTEX_SHADER);
    programLight.attachShader("./shaders/fragmentColorLight.glsl",GL_FRAGMENT_SHADER);
    programLight.link();
    programLight.addUniform("uMtxTransform");
    programLight.addUniform("uMtxView");
    programLight.addUniform("uMtxProj");
    programLight.addUniform("uColor");
    programLight.addUniform("uMtxNormal");
    ...
    model = meshManager.loadStl("./models/Star_Destroyer.stl");
    model->setTextureShader(&programTexture);
    model->setColorShader(&programLight);
